...
#define pth_sigjmpbuf jmp_buf
#define pth_sigsetjmp(buf) setjmp(buf)
#define pth_siglongjmp(buf,val) longjmp(buf,val)
...
#define pth_skaddr_sigstack(skaddr,sksize) (/*N.A.*/)
#define pth_sksize_sigstack(skaddr,sksize) (/*N.A.*/)
